...
public:
    ...
    virtual void setAspectRatio(double) = 0;
    ...
    //! Return the viewingtransformation matrix for the current camera settings.
    virtual Matrix4x4 getViewingTransformation() const = 0;
